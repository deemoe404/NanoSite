...
const translations = {
    ...
    tools: {
      ...
      themePack: '主題包',
      themeLayout: '版面',
      themeLayoutAuto: '主題預設',
      themeLayoutLocked: '站點已鎖定版面',
      language: '語言',
      resetLanguage: '重置語言'
    },
    toc: {
      ...
      composer: {
        ...
        site: {
          ...
          fields: {
            ...
            themeLayout: '主題版面',
            themeLayoutHelp: '為所選主題設定預設版面。留空則使用主題本身的預設版面。',
            themeLayoutAuto: '使用主題預設',
            themeLayoutOverride: '鎖定版面',
            themeLayoutOverrideHelp: '即使訪客切換，也強制使用此版面。',
            themeOverride: '鎖定主題',
