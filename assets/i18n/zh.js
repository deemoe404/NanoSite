...
const translations = {
    ...
    tools: {
      ...
      themePack: '主题包',
      themeLayout: '布局',
      themeLayoutAuto: '主题默认',
      themeLayoutLocked: '站点已锁定布局',
      language: '语言',
      resetLanguage: '重置语言'
    },
    toc: {
      ...
      composer: {
        ...
        site: {
          ...
          fields: {
            ...
            themeLayout: '主题布局',
            themeLayoutHelp: '为所选主题设置默认布局。留空则使用主题自带的默认布局。',
            themeLayoutAuto: '使用主题默认',
            themeLayoutOverride: '锁定布局',
            themeLayoutOverrideHelp: '即使访问者切换，也始终使用此布局。',
            themeOverride: '锁定主题',
