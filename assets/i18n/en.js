...
const translations = {
    ...
    tools: {
      ...
      themeLayout: 'Layout',
      themeLayoutAuto: 'Theme default',
      themeLayoutLocked: 'Layout locked by site',
      language: 'Language',
      ...
      composer: {
        ...
        site: {
          ...
          fields: {
            ...
            themeLayoutHelp: 'Default layout for the selected theme. Leave blank to follow the theme default.',
            themeLayoutAuto: 'Use theme default',
            themeLayoutOverride: 'Lock layout',
            themeLayoutOverrideHelp: 'Force the selected layout even if visitors change it.',
