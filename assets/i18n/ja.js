...
const translations = {
    ...
    tools: {
      ...
      themePack: 'テーマパック',
      themeLayout: 'レイアウト',
      themeLayoutAuto: 'テーマ既定',
      themeLayoutLocked: 'サイトで固定されたレイアウト',
      language: '言語',
      ...
      composer: {
        ...
        site: {
          ...
          fields: {
            ...
            themeLayout: 'テーマレイアウト',
            themeLayoutHelp: '選択したテーマで使用する既定のレイアウト。空欄の場合はテーマ既定を使用します。',
            themeLayoutAuto: 'テーマ既定を使う',
            themeLayoutOverride: 'レイアウトを固定',
            themeLayoutOverrideHelp: '訪問者が切り替えてもこのレイアウトを強制します。',
