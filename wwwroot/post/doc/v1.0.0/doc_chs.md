...
- `?lang=chs` — UI/内容语言。存储在 localStorage，并回退到浏览器与 `<html lang>`。
...
{
	"我的第一篇": {
		"chs": { "title": "我的第一篇", "location": "post/foo_chs.md", "excerpt": "..." },
...
```json
{
	"我的第一篇": { "location": "post/foo_chs.md", "tag": ["Note"], "date": "2025-08-13", "image": "..." }
}
```
...
- 内容支持：
	...
	- 旧版：`index.en.json`、`index.chs.json`...（回退）
...
- 新增标签页：
	...
	```json
	{ "关于": { "chs": { "title": "关于", "location": "tab/about.md" } } }
	```
