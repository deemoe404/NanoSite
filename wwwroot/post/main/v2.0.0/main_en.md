...
5) **Set your site name and links**
...
- For more customization options, see the [Documentation](?id=post/doc/v2.1.0/doc_en.md).
- For deploying to GitHub Pages, see [Deploying to GitHub Pages](?id=post/page/githubpages_en.md).
- For SEO optimization, see [SEO optimization](?id=post/seo/seo_en.md).
